...
( function( $ ) {
	...
	wp.customize( 'bookchapter_fontstyle', function( value ) {
		value.bind( function( newval ) {
			setstyles = newval.split(',');
      dosetstyles($('div.results p.book'),setstyles);
		} );
	} );
	...
	wp.customize( 'versenumber_fontstyle', function( value ) {
		value.bind( function( newval ) {
			setstyles = newval.split(',');
      dosetstyles($('div.results p.verses span.sup'),setstyles);
		} );
	} );
	...
	wp.customize( 'versetext_fontstyle', function( value ) {
		value.bind( function( newval ) {
			setstyles = newval.split(',');
      dosetstyles($('div.results p.verses'),setstyles);
		} );
	} );
