  ...
  registerBlockType("bibleget/bible-quote", {
    ...
    edit(props) {
      ...
      function changeBibleVersionAlign(ev) {
        let LAYOUTPREFS_BIBLEVERSIONALIGNMENT = parseInt(
      ...
      function changeParagraphStyleMarginTopBottom(
      ...
      function changeParagraphStyleMarginLeftRight(
        PARAGRAPHSTYLES_MARGINLEFTRIGHT
      ) {
        let bbGetDynSS = jQuery("#bibleGetDynamicStylesheet").text();
        let {
      ...
      function changeParagraphStyleMarginLeftRightUnit(
        PARAGRAPHSTYLES_MARGINLEFTRIGHTUNIT
      ) {
        let bbGetDynSS = jQuery("#bibleGetDynamicStylesheet").text();
        let {
      ...
      function changeParagraphStylePaddingTopBottom(
      ...
      function changeParagraphStylePaddingLeftRight(
        PARAGRAPHSTYLES_PADDINGLEFTRIGHT
      ) {
        let bbGetDynSS = jQuery("#bibleGetDynamicStylesheet").text();
      ...
      function doKeywordSearch(notused) {
        let keyword = $(".bibleGetSearch input")
            .val()
            .replace(
            ...
            success: function (response) {
              ...
              if (
                ...
                if (response.results.length === 0) {
                  ...
                  $searchresultsOrderedByReference.results.sort(function (
                    a,
                    b
                  ) {
                  ...
                  let $quotesArr,
                    dlg = jQuery("<div>", { html: searchResultsHtmlMarkup })
                      .appendTo("body")
                      .dialog({
                        open: function () {
                          $quotesArr = $(
      ...
      for (let [prop, val] of Object.entries(
            ...
            createElement(
              ...
              createElement(SelectControl, {
                ...
                options: Object.keys(BGET.BORDERSTYLE)
                  .sort(function (a, b) {
                    return BGET.BORDERSTYLE[a] - BGET.BORDERSTYLE[b];
                  })
                  .map(function (el) {
                    return {
